...
- Wording: the owner has asked that the word "halal" never appears on the site (no certificate; risk of a fine under the Trade Descriptions rules). Use "Muslim-owned, no pork, no lard, no alcohol" instead. This applies to the title, meta tags, JSON-LD, FAQ, pills, footer and og.png.
